...
namespace poisonDamage {
  ...
  function main {
    enter
    ldx #$0000; append.literal(output, "Took poison damage.")
    leave
    pea $8b5d
    jml $c08b90
  }
...
namespace fireDamage {
  ...
  function main {
    enter
    ldx #$0000; append.literal(output, "Took fire damage.")
    leave
    pea $8b70
    jml $c08b90
  }
...
namespace lavaDamage {
  ...
  function main {
    enter
    ldx #$0000; append.literal(output, "Took lava damage.")
    leave
    pea $8b83
    jml $c08b90
  }
