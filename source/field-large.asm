...
namespace palette {
  enqueue pc
  seek($c6a050)
  ds 2; dw color(29,29,18), color(14,14,14), color( 3, 3, 0)  //colors  9-11
  ds 2; dw color(31,31,31), color( 9,10,10), color(31,31, 0)  //colors 13-15
  dequeue pc
}
...
namespace renderLargeText {
  ...
  +;ldx $1c; lda.w buffer,x; and #$00ff; plp; rtl
  }
  ...
  function initialize {
    ...
    lda $0c,s; cmp #$9c95; bne +; lda.w #wramBuffer+8; sta wramOffset; +
