...
namespace status {
  ...
  seek($ee9948); jsl techniqueMenu
  seek($ee995a); jsl techniqueMenuLevel
  seek($ee9bc0); jsl drawWindowBG3
  seek($ee9c1e); jsl techniqueItem
  seek($ee9c2c); jsl techniqueItemLevel
  seek($ee9c3c); jsl techniqueItemCost
  ...
  seek($ee98cc); lda #$004a  //"Attack"#  position
  ...
  seek($ee9c30); lda #$009e  //"Technique Cost" position
  ...
  allocator.create( 9,1,class)
  allocator.create( 6,2,technique)
  ...
  allocator.create( 7,1,attackValue)
  allocator.create( 5,1,defenseLabel)
  allocator.create( 7,1,defenseValue)
  allocator.create( 5,1,speedLabel)
  allocator.create( 7,1,speedValue)
  allocator.create( 5,1,magicLabel)
  allocator.create( 7,1,magicValue)
  allocator.create( 9,1,weapon)
  allocator.create( 9,1,armor)
  allocator.bpp2()
  allocator.create( 6,5,techniqueMenu)
  allocator.create( 3,5,techniqueMenuLevel)
  allocator.create(8,24,techniqueItem)
  ...
  function dragonClass {
    enter
    and #$00ff; mul(9); tay
    lda #$0009; allocator.index(class); write.bpp4(lists.dragons.bpp4)
  ...
  function technique {
    enter
    and #$00ff; mul(8); tay
    lda #$0006; allocator.index(technique); write.bpp4(lists.techniques.bpp4)
    leave; rtl
  }
  ...
  function techniqueLevel {
    enter
    //todo: can this be printed without taking up more space than is available?
    leave; rtl
  }
  ...
  function techniqueItem {
    enter
    and #$00ff; mul(8); tay
    allocator.index(techniqueItem)
    lda #$0008; write.bpp2(lists.techniques.bpp2)
    leave; rtl
  }

  //A = technique level
  function techniqueItemLevel {
    enter
    and #$00ff; mul(3); tay
