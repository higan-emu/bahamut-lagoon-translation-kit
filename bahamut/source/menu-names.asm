...
namespace appendNameEntry {
  ...
  function main {
    ...
    enter
    lda.w #64+1; sta limit     //dragon name limit (8.0 tiles) + 1
    lda $ca; cmp.w #2; bcs +   //test if this is a player name
    lda.w #52+1; sta limit; +  //player name limit (6.5 tiles) + 1
...
namespace nameEntry {
  ...
  function draw {
    ...
    lda $001860              //this will write the tilemap where "Finished" is
    jsl spaceIndicator.draw  //this will place "Space" into VRAM
    sta $001860              //but this will overwrite it with "Finished" as desired

    ldy.w #strings.saves.finished
    lda #$0008; ldx #$0030; write.bpp4(lists.saves.bpp4)
    leave; rtl
  }
}
...
namespace spaceIndicator {
  ...
  function draw {
    enter
    ldy.w #strings.menu.space
    lda #$0004; ldx #$0030; write.bpp2(lists.menu.bpp2)
    leave; rtl
  }
...
namespace forceSinglePage {
  ...
  //------
  seek($eed7dc); {
    lda #$0003   //3 = "Finished" option
    sta $c0      //set current selected page to "Finished"
    lda.w #165   //load cursor X offset
    sta $001056  //store value
    lda.w #19    //load cursor Y offset
...
//note that the character map is technically encoded as lz77.
//but so long as we don't insert $1a or $1b pointer codes, we can just write out decompressed data.
characterMap: {
  ...
  dw $2000,$2000,$2000,$2000,$2000,$2000,$2000,$2000,$2087,$2000,$2088,$2000,$2089,$2000,$208a,$2000  //18
  dw $208b,$2000,$208c,$2000,$208d,$2000,$208e,$2000,$208f,$2000,$2000,$2000,$2000,$2000,$2000,$2000  //19
  ...
  dw $2000,$2000,$2000,$2000,$2000,$2000,$2000,$2000,$2090,$2000,$2091,$2000,$2092,$2000,$2093,$2000  //1c
  dw $2094,$2000,$2095,$2000,$2096,$2000,$2097,$2000,$2098,$2000,$2000,$2000,$2000,$2000,$2000,$2000  //1d
  ...
  dw $2000,$2000,$2000,$2000,$2000,$2000,$2000,$2000,$2099,$2000,$209a,$2000,$209b,$2000,$209c,$2000  //20
  dw $209d,$2000,$209e,$2000,$209f,$2000,$20a0,$2000,$2086,$2000,$2000,$2000,$2000,$2000,$2000,$2000  //21
  ...
  db $1a,$00,$01  //end of compressed block flag
}
