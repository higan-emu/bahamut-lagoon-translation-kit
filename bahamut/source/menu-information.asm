...
namespace information {
  ...
  seek($eeefa8); string.hook(page.noItems)    //"No Items" text
  ...
  seek($eea673); lda #$06ee     //"Page#" text position
  seek($eea633); lda #$06ee     //"Page#" window border cutout offset
  seek($eea639); ldy #$0007     //"Page#" window border cutout length

  seek($eeefbd); string.skip()  //disable static "Page" text
  seek($eeefd7); string.skip()  //disable static "-" page separator
  seek($eeeff0); lda #$06ee     //"Page#" text position
  seek($eeef97); lda #$06ee     //"Page#" window border cutout offset
  seek($eeef9d); ldy #$0007     //"Page#" window border cutout length
...
namespace dragonKeepersItemExplanation {
  ...
  macro stat(variable zindex, variable yindex, variable xindex, define name) {
    ...
    positive{#}: {
      pha; lda #$2800; sta $001862; pla; jsl write{#}
      lda $001860; tax
      lda #$28f1; sta $7ec400,x
      jmp finished{#}
    }
