...
namespace index {
  ...
  macro for3x16(define counter) {
    getTileIndex({counter}, 16)
    asl; tax; lda index.table3x16,x; tax
  }

  macro for2x16(define counter) {
    getTileIndex({counter}, 16)
    asl; tax; lda index.table2x16,x; tax
  }
  ...
  macro to3x16() {
    and #$00ff; asl; tax; lda index.table3x16,x; tax
  }

  macro to2x16() {
    and #$00ff; asl; tax; lda index.table2x16,x; tax
  }
  ...
  macro to3x16(variable index) {; lda.w #index; index.to3x16(); }
  macro to2x16(variable index) {; lda.w #index; index.to2x16(); }
  ...
  //$088-$0a7
  table2x16: {
    dw $088,$08a,$08c,$08e,$090,$092,$094,$096
    dw $098,$09a,$09c,$09e,$0a0,$0a2,$0a4,$0a6
  }
...
namespace string {
  ...
  function write {
    ...
    cmp.w #constants.strings.wisdom;    bne +; leave; rtl; +
    cmp.w #constants.strings.affection; bne +; leave; rtl; +
    leave; rtl
  }
}
...
namespace status {
  ...
  //todo: disambiguate dragon name and skip rendering it here
  //A = player name
  //X = tilemap index
  function name {
    variable(2, counter)
...
namespace experience {
  ...
  function main {
    ...
    ldx #$0000; txy
    lda value; append.alignRight(30); append.integer_5()
...
namespace piro {
  ...
  seek($c17532); nop #3            //disable printing of static "Piro" text
  dequeue pc
  ...
  function main {
    ...
    lda $092f; sta value
    ldx #$0000; txy
    append.alignRight(50); append.integer_5(); append.literal(" Piro")
...
namespace enemy {
  ...
  seek($c147df); jsl hp; jmp $4803
  seek($c1482b); jsl mp; jmp $4839
  seek($c146af); jsl setWindowWidth; nop
  seek($c147c2); jmp $47cb  //disable static "HP" text
  seek($c14817); jmp $4820  //disable static "MP" text
  seek($c148fb); lda #$12   //replace ":" after enemy attribute icons with " "
  dequeue pc
...
//action menu:
//presents a list of techniques that can be performed by the current character
namespace menu {
  enqueue pc
...
namespace technique {
  ...
  seek($c13de1); lda #$0e    //window width
  seek($c13e23); nop #3      //disable 'Lv.' marker
  seek($c13e76); ldy #$000b  //# of tiles to gray when MP/SP is too low to use a technique
  dequeue pc
  ...
  function details {
    ...
    lda level; mul(3); tay
    index.for3x16(counterLevel)
    lda #$0003; write.bpp4(lists.levels.bpo4)
    txy; lda index; tax
    lda #$0003; tilemap.write()

    lda cost; mul(2); tay
    index.for2x16(counterCost)
    lda #$0002; write.bpp4(lists.costs.bpo4)
    txy; lda index; add #$0006; tax
    lda #$0002; tilemap.write()
...
namespace item {
  ...
  function dropped {
    ...
    lda $0871,y; and #$00ff
    mul(3); tay
    index.for3x16(counter)
    lda #$0003; write.bpp4(lists.counts.bpo4)
  ...
  namespace use {
    ...
    function setTotal {
      ...
      ldx #$0000; txy; append.alignRight(30)
  ...
  namespace page {
    ...
    function setTotal {
      ...
      ldx #$0000; txy
      append.alignLeft(1); append.literal("Page "); append.alignRight(30)
      lda index; append.integer_2(); append.literal("/")
      lda total; append.integer_2()
      lda #$0007; render.small.bpa4()
      index.for8x2(counter)
      lda #$0007; write.bpp4()
      txy; jsl tilemap.calculateIndex; sub #$000a; tax
      lda #$0007; tilemap.write()
      leave; rtl
    }
  }
}
