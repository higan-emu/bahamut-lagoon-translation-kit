...
namespace dragons {
  ...
  macro value(variable index, variable separator, variable tiles, define stat) {
    ...
    if index == 1 {
      //MP
      lda points; tax
      lda.l dragons.stats.{stat},x; ldx #$0000; append.alignRight(18)
  ...
  function values {
    ...
    enter; ldb #$7e
    txa; sta points
    lda $0967; and #$00ff; sub #$0020; mul(32); sta stats
    value( 0,1,2,hp)
    value( 1,1,2,mp)
    value( 2,0,1,fire)
    value( 3,1,1,water)
