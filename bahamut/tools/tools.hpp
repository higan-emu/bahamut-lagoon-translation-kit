...
namespace Command {
  ...
  static constexpr u8 FontNormal  = 0xf6;
  static constexpr u8 FontYellow  = 0xf7;
  static constexpr u8 AlignCenter = 0xf8;
  static constexpr u8 AlignRight  = 0xf9;
  static constexpr u8 SkipPixels  = 0xfa;
  static constexpr u8 OffsetLines = 0xfb;
