...
struct Script : TextExtractor {
  ...
  u16 base;         //blocks are always encoded as {commands, text}; base is the start of the text
  u16 origin;       //origin is a decompressed data offset used only by field scripts (always 0 for chapters)
